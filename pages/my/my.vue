<template>
	<view>
		<cu-custom bgColor="bg-gradual-blue" :isBack="false"><block slot="backText"></block><block slot="content">我的网盘</block></cu-custom>
		<!-- <file-item :list="list" @onClick="onClick" @more.stop="more"></file-item> -->
