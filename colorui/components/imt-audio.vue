<template>
	<view class="imt-audio">
		...
		<view class="audio-control-wrapper" :style="{color:color}">
			<view class="audio-control audio-control-prev bg-gray text-gray" v-if="control"  @click="prev">&#xe601;</view>
			...
			<view class="audio-control audio-control-next bg-gray text-gray" v-if="control"  @click="next">&#xe601;</view>
		</view>
	</view>
</template>
