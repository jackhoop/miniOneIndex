<template>
  <view class="carousel-3d-container" :style="{height: this.slideHeight + 'upx'}">
    <view class="carousel-3d-slider" :style="{width: this.slideWidth + 'upx', height: this.slideHeight + 'upx'}">
      <slot></slot>
    </view>
  </view>
</template>
